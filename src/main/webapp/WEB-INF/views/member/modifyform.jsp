				...
				<div class="inner">
					...
					<div class="row gtr-200">
						<div class="col-6 col-12-medium">
							...
							<form class="form-signin" id="mypage-form" name="modifyform" method="get" action="/mysiteB/user">
								...
								<div class="row gtr-uniform">
									...
									<div class="col-6 col-12-xsmall">
										...
										<input type="password" name="memPass" id="demo-email" value=""
									...
									<div class="col-6 col-12-xsmall">
										...
										<input type="password" name="memPass_confirm" id="demo-email" value=""
											placeholder="passoword" />
									</div>
									...
									<input type="text" name="memName" id="demo-email" value=""
											placeholder="name" />
									...
									<div class="col-6 col-12-xsmall">
										...
										<input type="text" name="memPhone" id="demo-email" value=""
											placeholder="phone" />
									</div>
